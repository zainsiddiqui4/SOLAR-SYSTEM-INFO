# 🪐 SOLARIS — An Interactive Solar System Website

> A fully responsive, educational website about our solar system — built with pure HTML, CSS, and JavaScript as my first web development project.
...
This project was built to practise and solidify the fundamentals of front-end web development, including semantic HTML structure, CSS animations, responsive layouts, and basic DOM manipulation in JavaScript.
...
- How to structure a multi-section webpage using semantic HTML5 elements
- CSS custom properties (variables) for consistent theming across a whole project
- Building complex animations with `@keyframes` and `transform` without any JS
- Using CSS Grid and Flexbox together for responsive layouts
- The IntersectionObserver API for performant scroll-triggered effects
...
This is my first complete web project. I'm currently learning front-end development and working towards freelancing in web design and development.

| | |
|---|---|
| 🎓 | BS Computer Science — FAST NUCES (2025–Present) |
| 📍 | Pakistan |
